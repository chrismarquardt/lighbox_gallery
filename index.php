...
if (isset($_GET['upload_images']) && is_admin()) {
    ...
    $ordered = array_values(array_unique(array_merge(array_values(array_diff($existing, $saved)), $saved)));
...
#series-main,.series-strip{grid-template-columns:repeat(2,1fr)}
#series-main.series-count-many,.series-strip.series-count-many{grid-template-columns:repeat(6,1fr)}
#series-main.series-count-many .tile,.series-strip.series-count-many .tile{grid-column:span 2}
#series-main:not(.series-count-many) .tile:last-child:nth-child(odd),.series-strip:not(.series-count-many) .tile:last-child:nth-child(odd){grid-column:1/-1;width:50%;margin:0 auto}
#series-main.series-count-many .tile:nth-last-child(1):nth-child(3n+1),.series-strip.series-count-many .tile:nth-last-child(1):nth-child(3n+1){grid-column:3/span 2}
#series-main.series-count-many .tile:nth-last-child(2):nth-child(3n+1),.series-strip.series-count-many .tile:nth-last-child(2):nth-child(3n+1){grid-column:2/span 2}
#series-main.series-count-many .tile:nth-last-child(1):nth-child(3n+2),.series-strip.series-count-many .tile:nth-last-child(1):nth-child(3n+2){grid-column:4/span 2}
@media(max-width:520px){#series-main,.series-strip,#series-main.series-count-many,.series-strip.series-count-many{display:grid;grid-template-columns:repeat(2,var(--series-mobile-tile-size));grid-auto-rows:var(--series-mobile-tile-size);align-items:start;justify-content:center}#series-main .tile,#series-main.series-count-many .tile,.series-strip .tile,.series-strip.series-count-many .tile,#series-main.series-count-many .tile:nth-last-child(1):nth-child(3n+1),.series-strip.series-count-many .tile:nth-last-child(1):nth-child(3n+1),#series-main.series-count-many .tile:nth-last-child(2):nth-child(3n+1),.series-strip.series-count-many .tile:nth-last-child(2):nth-child(3n+1),#series-main.series-count-many .tile:nth-last-child(1):nth-child(3n+2),.series-strip.series-count-many .tile:nth-last-child(1):nth-child(3n+2){display:block!important;grid-column:auto!important;width:var(--series-mobile-tile-size)!important;min-width:var(--series-mobile-tile-size)!important;max-width:var(--series-mobile-tile-size)!important;height:var(--series-mobile-tile-size)!important;min-height:var(--series-mobile-tile-size)!important;max-height:var(--series-mobile-tile-size)!important;aspect-ratio:auto!important;margin:0!important;overflow:hidden!important}#series-main .tile>img,.series-strip .tile>img{position:absolute!important;inset:0!important;width:100%!important;height:100%!important;max-width:none!important;object-fit:cover!important}#series-main .tile:last-child:nth-child(odd),.series-strip .tile:last-child:nth-child(odd),#series-main.series-count-many .tile:last-child:nth-child(odd),.series-strip.series-count-many .tile:last-child:nth-child(odd){grid-column:1/-1!important;justify-self:center}.series-strip--all .tile,.series-strip--all.series-count-many .tile{width:calc(var(--series-mobile-tile-size)*.8)!important;min-width:calc(var(--series-mobile-tile-size)*.8)!important;max-width:calc(var(--series-mobile-tile-size)*.8)!important;height:calc(var(--series-mobile-tile-size)*.8)!important;min-height:calc(var(--series-mobile-tile-size)*.8)!important;max-height:calc(var(--series-mobile-tile-size)*.8)!important;justify-self:center}.all-photos-link-wrap{padding-top:.35rem!important}}
#series-home-wrap{flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center}
#series-home-wrap #series-main{width:100%}
